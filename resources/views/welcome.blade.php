...
.menu-wrap .menu > div > div > ul > li > a {
  ...
  <header class="showcase">
    <div class="container showcase-inner">
      <h1>Platform Professeur</h1><br>
      <p>Log in ou S'inscrire pour obtenir un compte Professeur</p><br><br>
     ...
     <center> @if (Route::has('login'))
                <div class="menu">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="A">Log in</a>
